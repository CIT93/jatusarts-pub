...
//localStorage.setItem(LOCAL_STORAGE_KEY, "jatusart");
//localStorage.setItem(LOCAL_STORAGE_KEY, 12);
//localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify([1, 2, 3]));
//localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify({name: "jatusart"}));
...
export const loadEntries = function () {
    try {
        ...
        // if not data is found in localStorage, return an empty array.
        return [];
